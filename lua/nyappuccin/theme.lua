...
M.theme = lush(function(injected_functions)
    ...
    return {
        ...
        DiffAdd { bg = C.green.mix(C.base, 60).de(20) },     -- Diff mode: Added line |diff.txt|
        -- DiffChange     { }, -- Diff mode: Changed line |diff.txt|
        DiffDelete { bg = C.red.mix(C.base, 60).de(20) },    -- Diff mode: Deleted line |diff.txt|
        ...
        DiagnosticUnderlineError { DiagnosticError, underline = false, undercurl = true }, -- Used to underline "Error" diagnostics.
        DiagnosticUnderlineWarn { DiagnosticWarn, underline = false, undercurl = true },   -- Used to underline "Warn" diagnostics.
        DiagnosticUnderlineInfo { DiagnosticInfo, underline = false, undercurl = true },   -- Used to underline "Info" diagnostics.
        DiagnosticUnderlineHint { DiagnosticHint, underline = false, undercurl = true },   -- Used to underline "Hint" diagnostics.
        DiagnosticUnderlineOk { DiagnosticOk, underline = false, undercurl = true },       -- Used to underline "Ok" diagnostics.
        ...
        sym "@constructor.lua" { fg = C.lavender },
